label story5:
    scene bg yuriact1
    play music intro_yuri
    "Act 1"
    "Retribution"
    "The siren's sweet melody entranced the breeze, as the shattered glass reflected the call to right the wrongs that others have caused."
    ...
    "However, I just let her catch up to me. Perhaps something good will come out of this?"
    $ s_name = "Sayori"
    show sayori 4p at t11 zorder 2
    s 4p "Haaahhh...haaahhh..."
    s "I overslept again!"
    s "But I caught you this time!"
    mc "Maybe, but you know that's only because I only stopped to wait for you!"
    show sayori at s11
    s 5c "Eeehhhhh, that's not true! I would've caught you either way [player]!"
    mc "That's not true and you know it Sayori."
    show sayori at t11 zorder 2
    s "Fine, fine."
    s 4a "But you did wait for me, after all."
    s 4s "I really appreciate that!"
    ...
    "After I pack up my things, I stare blankly at the wall, looking for motivation so I can keep my promise to Sayori."
    mc "Clubs..."
    "Sayori wants me to check out some clubs."
    "I guess I'll start with the anime club! "
    ...
    "I was never aware she had interest in literature."
    "I can admire her devotion but I cant pretend I have any interest in literature."
    "Since she was the first one to show interest after the one who proposed the club, she inherited the title \"Vice President\"."
    "That said, my interest in literature is guaranteed to be small."
    ...
    mc "Fine... I'll check it out okay?"
    show sayori at h11
    s 4r "Yes! Let's go~!"
    ...
    "And thus, today marks the day I sold my soul for Sayori (moreso the cupcakes)"
    ...
    y "Welcome to the Literature Club [player]! It's a pleasure to meet you."
    y "Sayori always says nice things about you."
    mc "Wait how do you know my name?"
    show yuri 3y6
    y "Well I heard from Sayori, she always talks about you."
    show yuri 1m at t22 zorder 2
    ...
    y "Natsuki shut up."
    $ n_name = 'Natsuki'
    show yuri 1r at t33 zorder 2
    show natsuki at f32 zorder 3
    n 5p "What the hell Yuri?"
    n 5p "Maybe you should shut up!"
    show sayori 4p at f31 zorder 3 
    s 4p "Guys! We shouldn't act like this in front of a new member!"
    show yuri 1o at s33 zorder 3 
    show natsuki 5s at t32 zorder 2
    "Well that seems to have solved that."
    ...
    s "Though, I've never seen Yuri act like that."
    ...
    y 1y5 "That's me!"
    "Natsuki does seem aggressive, but Yuri is on a whole different level."
    show yuri at t33 zorder 2
    ...
    show yuri at h21
    y 3r "Oh shut up Monika! No one asked for your input."
    show monika 2o at s22 zorder 2 
    "Evidently hurt by Yuri's words, Monika decides not to interfere with Yuri's conversation."
    m "Sorry Yuri.."
    show monika at thide zorder 1
    hide monika 
    show yuri at t11
    y 1h "I meant that, you know. Tea really does help"
    mc "I believe you."
    mc "Well, tea and reading might not be a pastime for me, but I at least enjoy tea."
    y 1c "I'm glad you do."
    ...
    show yuri 1y5 at t31 zorder 2
    y "We'll try if that's what [player] wants!"
    show monika at t44 zorder 2
    show sayori at t43 zorder 2
    show yuri at t42 zorder 2
    show natsuki 4d at t41 zorder 2
    n "You know it!"
    "Everyone enthusiastically agrees. Although I don't know why my opinion matters to Yuri.."
    ...
    show natsuki at thide zorder 1
    hide natsuki
    y 3k "N-Not much of a reader, I guess..."
    ...
    "She seemed aggressive since the moment I walked in, but it seems that when she talks about her books she relaxes."
    ...
    y 1a "If a story makes me think, or takes me to another world, then I really can't put it down."
    ...
    show yuri at h31
    y 1y5 "I will if [player] wants to read them.."
    "Again?? She seems so invested in me.."
    show sayori 2g at t32 zorder 2
    s 1r "Aww... That's sweet Yuri! I'm glad [player] is getting you out of your comfort zone!"
    "If that's how you want to spin it..."
    y 1l"Eh, I was planning on doing that soon anyway.. Even if [player] never came."
    show sayori at thide zorder 1
    show yuri at thide zorder 1
    show monika at thide zorder 1
    hide sayori
    ...
    y 1y6 "I knew you would come to your senses."
    show yuri at t42 zorder 2
    ...
    "The whole way, my mind wanders back and forth between the four girls: Though one stands out."
    show yuri 1 at t11 zorder 2
    "Yuri."
    "So mysterious and quiet, yet she can stand up for herself.."
    "She scared me a bit at first.. But I think she's growing on me."
    "Perhaps I'll have the chance to grow closer to Yuri?"
    hide yuri
    with wipeleft
    "Alright!"
